# Generated by Django 2.2.12 on 2022-07-11 17:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_account', models.CharField(max_length=20, verbose_name='用户账号')),
            ],
            options={
                'verbose_name': '环境管理',
                'db_table': 'EnvInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.TextField(null=True, verbose_name='子级目录存放文件')),
